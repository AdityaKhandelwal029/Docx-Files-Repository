...
start Teamcenter.exe %* -vm "%JRE_HOME%\bin\javaw.exe" -vmargs -Dautologin.user=ak927337.ttl -Dautologin.pass=Jaishreekrishna@123 -Xmx%VM_XMX% %DJIPJL_VMARG%  --add-opens java.desktop/javax.swing=ALL-UNNAMED
